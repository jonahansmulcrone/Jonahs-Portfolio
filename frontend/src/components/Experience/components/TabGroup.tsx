            ...
            >
                ...
                <TabPanel value={value} index={0}>
                    <div className={styles.tabJobTitle}>
                        Software Development Intern <span className={styles.accentColor}>@ Onyx AI</span>
                    </div>
                ...
                <TabPanel value={value} index={1}>
                    <div className={styles.tabJobTitle}>
                        Software Development Intern <span className={styles.accentColor}>@ Pierce County</span>
                    </div>
                    <div className={styles.tabJobDateRange}>
